...
if(!chapterMap.includes('const passiveMobile =')||!chapterMap.includes('dragging:!passiveMobile')||!chapterMap.includes('fitAll(){ fitRecords(currentRecords); }'))errors.push('chapter map must preserve the current passive-mobile and fit-all UX');
