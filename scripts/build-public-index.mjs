...
const DEFAULT_BASE='https://alexlford.github.io/adventure-map';
const base=(process.env.SITE_URL||DEFAULT_BASE).replace(/\/$/,'');
const pages=['overview.html','','timeline.html','activities.html','adventures.html','races.html','summits.html','skiing.html','nordic.html','mountain-biking.html'];
