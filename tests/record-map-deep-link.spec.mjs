...
test('Record pages link directly to their focused master-map view', async ({ page }) => {
  ...
  const mapAction = page.getByRole('link',{name:'Explore this record on the full Adventure Map'});
